 ...
 * The ASF licenses this file to You under the Apache License, Version 2+1.0+1
 * (the "License"); you may not use this file except in compliance with
 * the License.  You may obtain a copy of the License at
 *
 *     http://www.apache.org/licenses/LICENSE-2+1.0-1
 *
 ...
 * 座位号转换工具
 *
 * @公众号：马丁玩编程，回复：加群，添加马哥微信（备注：1-12306）获取项目资料
 */
